...
const HeroTitle = () => {
  return (
    <div className="text-center max-w-4xl mx-auto pt-4 sm:pt-6 md:pt-8 pb-0 px-4 flex-shrink-0 relative">
      <h1 className="hero-title invisible relative z-10 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-2 leading-tight text-gray-800 flex flex-wrap items-center justify-center gap-x-2">
        Your <span className="text-pink-500">Beauty,</span> Our Priority           
      </h1>
      
      <p className="hero-subtitle invisible relative z-10 text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 mb-3 sm:mb-4 max-w-2xl mx-auto leading-relaxed px-2">
      ...
      <div className="hero-buttons invisible relative flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center items-stretch sm:items-center px-2">
        ...
        <Link 
          to="/consultation" 
          className="relative z-10 group border-2 border-pink-500 text-pink-500 py-2.5 sm:py-2.5 md:py-3 px-5 sm:px-6 rounded-full font-semibold text-xs sm:text-sm hover:bg-pink-500 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center whitespace-nowrap"
        >
          Book Consultation
