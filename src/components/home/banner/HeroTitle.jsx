  ...
  return (
    <div className="text-center max-w-4xl mx-auto pt-4 sm:pt-6 md:pt-8 pb-0 px-4 flex-shrink-0 relative">
      ...
      <div className="hero-buttons invisible relative flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center items-stretch sm:items-center px-2">
        <Link
          to="/shop"
          className="relative z-10 group bg-pink-500 text-white py-3 sm:py-2.5 md:py-3 px-6 sm:px-6 rounded-full font-semibold text-sm sm:text-sm hover:bg-pink-600 transition-all duration-300 transform hover:scale-105 flex items-center justify-center whitespace-nowrap"
        >
          Explore Products
        ...
        <Link
          to="/consultation"
          className="relative z-10 group border-2 border-pink-500 text-pink-500 py-3 sm:py-2.5 md:py-3 px-6 sm:px-6 rounded-full font-semibold text-sm sm:text-sm hover:bg-pink-500 hover:text-white transition-all duration-300 transform hover:scale-105 flex items-center justify-center whitespace-nowrap"
        >
          Book Consultation
