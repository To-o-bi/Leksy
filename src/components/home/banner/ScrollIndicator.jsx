...
const ScrollIndicator = () => {
  ...
  return (
    <div className="scroll-indicator invisible absolute bottom-6 sm:bottom-12 md:bottom-20 left-1/2 -translate-x-1/2 z-30 w-full text-center pointer-events-none">
