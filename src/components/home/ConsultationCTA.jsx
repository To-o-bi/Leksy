...
const ConsultationCTA = () => {
  ...
  return (
    <section className="relative py-20 md:py-24 text-white overflow-hidden">
      ...
      <div 
        className="absolute top-0 left-0 w-full h-full z-5 opacity-10" 
        style={{ 
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/* <button 
              ...
              className="px-8 py-3 bg-transparent border-2 border-white text-white text-lg font-medium rounded-md hover:bg-white/10 transition-all duration-300"
            >
              Learn More
            </button> */}
          </div>
