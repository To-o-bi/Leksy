...
const Tooltip = ({ text }) => (
  <div className="absolute right-full mr-4 top-1/2 -translate-y-1/2 w-max bg-gray-800 text-white text-sm font-semibold py-2 px-4 rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transform translate-x-4 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap">
    {text}
    {/* Optional: Add a little triangle pointing to the icon */}
          ...
          <div className={`absolute bottom-16 right-0 flex flex-col items-end space-y-3 transition-all duration-500 ${
            ...
            <div className={`transform transition-all duration-300 ${socialExpanded ? 'translate-y-0' : 'translate-y-4'}`}
              ...
              <div className="relative group flex items-center">
                <Tooltip text="Follow our journey & get daily beauty tips! ✨" />
                <a href="https://www.instagram.com/leksy.cosmetics?igsh=MWR5OWtpNG44ZHR2Mw==" className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-purple-600 via-pink-600 to-yellow-500 hover:from-purple-700 hover:via-pink-700 hover:to-yellow-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">                   
            ...
            <div className={`transform transition-all duration-300 ${socialExpanded ? 'translate-y-0' : 'translate-y-4'}`}
              ...
              <div className="relative group flex items-center">
                <Tooltip text="Drop us a line for support or inquiries. 💌" />
                <a href="mailto:hello@beauty.com" className="flex items-center justify-center w-12 h-12 bg-gray-600 hover:bg-gray-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
            ...
            <div className={`transform transition-all duration-300 ${socialExpanded ? "translate-y-0" : "translate-y-4"}`}
              ...
              <div className="relative group flex items-center">
                <Tooltip text="Go behind the scenes with us! 👻" />
                <a href="https://snapchat.com/t/dqHNOMmX" className="flex items-center justify-center w-12 h-12 bg-yellow-400 hover:bg-yellow-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 16 16" fill="black" stroke="black" strokeWidth="0.6" className="bi bi-snapchat">
            ...
            <div className={`transform transition-all duration-300 ${socialExpanded ? 'translate-y-0' : 'translate-y-4'}`}
              ...
              <div className="relative group flex items-center">
                <Tooltip text="Chat with a beauty expert now! 💬" />
                <a href="http://wa.me/2349014425540" className="flex items-center justify-center w-12 h-12 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110">
